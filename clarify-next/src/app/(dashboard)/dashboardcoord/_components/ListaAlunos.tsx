  ...
  return (
    <section>
      <div className="flex flex-col gap-3 mb-4 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-xl font-bold text-gray-900 dark:text-slate-100">Alunos</h2>
        {alunos.length > 0 && (
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="w-full pl-8 pr-8 py-2 border border-gray-200 dark:border-slate-700 rounded-lg bg-gray-50 dark:bg-slate-800 text-sm text-gray-900 dark:text-slate-100 outline-none focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 transition-colors"
            />
            {busca && (
              <button
                type="button"
